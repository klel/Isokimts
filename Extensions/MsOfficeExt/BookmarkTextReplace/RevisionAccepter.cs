...
namespace OpenXmlPowerTools
{
    ...
    public class AcceptRevisionsInternalException : Exception
    {
        public AcceptRevisionsInternalException(string message) : base(message) { }
    }
    ...
    public static class LocalExtensions
    {
        private static void InitializeParagraphInfo(XElement contentContext)
        {
            if (!(W.BlockLevelContentContainers.Contains(contentContext.Name)))
                throw new AcceptRevisionsInternalException(
